...
function createCon1 {
  ...
  echo
	echo "Enroll the CA admin"
  echo
	mkdir -p organizations/peerOrganizations/con1.example.com/

	export FABRIC_CA_CLIENT_HOME=${PWD}/organizations/peerOrganizations/con1.example.com/
#  rm -rf $FABRIC_CA_CLIENT_HOME/fabric-ca-client-config.yaml
#  rm -rf $FABRIC_CA_CLIENT_HOME/msp
  ...
  mkdir -p organizations/peerOrganizations/con1.example.com/peers/peer0.con1.example.com
  ...
  cp ${PWD}/organizations/peerOrganizations/con1.example.com/peers/peer0.con1.example.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/con1.example.com/peers/peer0.con1.example.com/tls/ca.crt
  cp ${PWD}/organizations/peerOrganizations/con1.example.com/peers/peer0.con1.example.com/tls/signcerts/* ${PWD}/organizations/peerOrganizations/con1.example.com/peers/peer0.con1.example.com/tls/server.crt
  cp ${PWD}/organizations/peerOrganizations/con1.example.com/peers/peer0.con1.example.com/tls/keystore/* ${PWD}/organizations/peerOrganizations/con1.example.com/peers/peer0.con1.example.com/tls/server.key

  mkdir ${PWD}/organizations/peerOrganizations/con1.example.com/msp/tlscacerts
  cp ${PWD}/organizations/peerOrganizations/con1.example.com/peers/peer0.con1.example.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/con1.example.com/msp/tlscacerts/ca.crt

  mkdir ${PWD}/organizations/peerOrganizations/con1.example.com/tlsca
  cp ${PWD}/organizations/peerOrganizations/con1.example.com/peers/peer0.con1.example.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/con1.example.com/tlsca/tlsca.con1.example.com-cert.pem

  mkdir ${PWD}/organizations/peerOrganizations/con1.example.com/ca
  cp ${PWD}/organizations/peerOrganizations/con1.example.com/peers/peer0.con1.example.com/msp/cacerts/* ${PWD}/organizations/peerOrganizations/con1.example.com/ca/ca.con1.example.com-cert.pem

  mkdir -p organizations/peerOrganizations/con1.example.com/users
  mkdir -p organizations/peerOrganizations/con1.example.com/users/User1@con1.example.com
